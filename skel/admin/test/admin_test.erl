    ...
    [ "Admin interface at /admin",
      fun(Response1) ->
          boss_web_test:follow_link("/admin", Response1,
            [ fun boss_assert:http_ok/1,
              fun(Res) -> boss_assert:tag_with_text("title", "Chicago Boss Admin - General Info", Res) end
            ],
            [ "Click Models",
              fun(Response1a) ->
                  boss_web_test:follow_link("Models", Response1a,
                    [ fun boss_assert:http_ok/1,
                      fun (Res) -> boss_assert:link_with_text("greeting", Res) end
                    ],
                    [ "Click greeting",
                      fun(Response2) ->
