...
-export([parse_post/0, get_post_value/1]).
...
%% @doc Get the value of the given query string parameter.
get_qs_value(Key) ->
...
%% @spec get_post_value(Key::string) -> string() | undefined
%% @doc Get the value of the given POST parameter.
get_post_value(Key) ->
    proplists:get_value(Key, parse_post()).
